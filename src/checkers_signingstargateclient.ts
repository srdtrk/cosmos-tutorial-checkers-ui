import { Registry, GeneratedType, OfflineSigner } from "@cosmjs/proto-signing";
import {
...
export const checkersDefaultRegistryTypes: ReadonlyArray<
    [string, GeneratedType]
> = [...defaultRegistryTypes, ...checkersTypes];
...
export class CheckersSigningStargateClient extends SigningStargateClient {
    ...
    protected constructor(
        ...
        if (tmClient) {
            this.checkersQueryClient = QueryClient.withExtensions(
                tmClient,
                setupCheckersExtension
            );
        }
